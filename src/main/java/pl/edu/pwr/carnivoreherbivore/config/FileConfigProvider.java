...
public class FileConfigProvider implements ConfigProvider {
    ...
    public SimulationParameters get() {
        ...
        try {
            ...
            sP.plantNutritionalValue = getInt(appProperties, "plantNutritionalValue", "20");
            sP.herbivoreStartingEnergy = getFloat(appProperties, "herbivoreStartingEnergy", "50");
            sP.carnivoreStartingEnergy = getFloat(appProperties, "carnivoreStartingEnergy", "50");
            sP.herbivoreEnergyConsumptionPerSecond = getFloat(appProperties, "herbivoreEnergyConsumptionPerSecond", "4");
            sP.carnivoreEnergyConsumptionPerSecond = getFloat(appProperties, "carnivoreEnergyConsumptionPerSecond", "6");
            ...
            sP.herbivoreSightRange = getFloat(appProperties, "herbivoreSightRange", "100");
            sP.carnivoreSightRange = getFloat(appProperties, "carnivoreSightRange", "100");
            sP.baseHerbivoreNutritionalValue = getFloat(appProperties, "baseHerbivoreNutritionalValue", "0");
